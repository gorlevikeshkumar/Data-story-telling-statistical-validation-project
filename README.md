...
- Perform hypothesis testing using Python.
...
- Customer segments contributed almost equally to total sales.
...
There is **no significant difference** between the average monthly sales and the business target.

### Alternative Hypothesis (H₁)

There **is a significant difference** between the average monthly sales and the business target.
